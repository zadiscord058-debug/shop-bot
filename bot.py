...
class TicketButtons(discord.ui.View):
    ...
    async def claim(self, interaction: discord.Interaction, button: discord.ui.Button):
        ...
        if not has_role(interaction.user, MM_ROLE_ID):
            return await interaction.response.send_message("Only MM can use this.", ephemeral=True)
    ...
    async def close(self, interaction: discord.Interaction, button: discord.ui.Button):
        ...
        if not has_role(interaction.user, MM_ROLE_ID):
            return await interaction.response.send_message("Only MM can close tickets.", ephemeral=True)
